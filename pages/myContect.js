        ...
        <div className="bg-gray-300 whitespace-nowrap">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3">
                <div className="bg-white shadow-lg flex flex-col relative space-y-20 w-[250px] items-center justify-center rounded-md mx-auto m-10">
                    <div class="bg-black rounded-full w-20 h-20 m-5 absolute -top-10 shadow-lg">
                        <a href="https://github.com/pbvansh" className="">
                            <svg
                                class="w-20 h-20 text-white fill-current cursor-pointer p-2 hover:text-gray-400"
                ...
                <div className="bg-white shadow-lg flex flex-col relative space-y-20 w-[250px] items-center justify-center rounded-md mx-auto m-10">
                    <div class="bg-blue-500 hover:bg-blue-800 rounded-full w-20 h-20 whitespace-nowrap m-5 absolute -top-10 shadow-lg">
                        <a href="https://www.linkedin.com/in/pratik-vansh-955b74232/">
                            <svg
                                class="w-20 h-20 text-white fill-current cursor-pointer p-2"
                ...
                <div className="bg-white shadow-lg flex flex-col relative space-y-20 w-[250px] items-center justify-center rounded-md mx-auto m-10">
                    <div class="bg-white hover:bg-blue-100 rounded-full w-20 h-20 whitespace-nowrap m-5 absolute -top-10 shadow-lg">
